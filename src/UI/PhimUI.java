...
public class PhimUI extends JPanel implements ActionListener {
	...
	public PhimUI() {
		...
		tablePhim.getTableHeader().setFont(new Font("Segoe UI", Font.BOLD, 12));
		tablePhim.setFont(new Font("Segoe UI", Font.PLAIN, 12));
		...
		txtMaPhim.setBackground(Color.LIGHT_GRAY);
		...
		// --- Button Creation with Icons & Style ---
	...
	private void updateButtonStates() {
		...
		setFieldsEditable(!isIdle, false); // MaPhim không được chỉnh sửa
	}
